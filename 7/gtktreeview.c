...
gtk_tree_store_set (store, &parent_iter, COLUMN_TITLE, "다시 부르기", COLUMN_ARTIST, "정인", COLUMN_CATALOGUE, "A931001",-1);
gtk_tree_store_append (store, &child_iter, &parent_iter);
gtk_tree_store_set (store, &child_iter, COLUMN_TITLE, "장마", -1);
